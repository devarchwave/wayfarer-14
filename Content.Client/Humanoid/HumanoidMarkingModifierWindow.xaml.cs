...
public sealed partial class HumanoidMarkingModifierWindow : DefaultWindow
{
    ...
    public HumanoidMarkingModifierWindow()
    {
        ...
        MarkingPickerWidget.OnMarkingDataChanged += set => OnMarkingColorChange!(set); // Wayfarer/Coyote: MarkingPickerWidget.OnMarkingColorChange to MarkingPickerWidget.OnMarkingDataChanged
