...
public sealed partial class MarkingPicker : Control
{
    ...
    public Action<MarkingSet>? OnMarkingDataChanged; //Wayfarer/Coyote: OnMarkingColorChange to OnMarkingDataChanged
    ...
    public MarkingPicker()
    {
        ...
        //Wayfarer/Coyote: Marking System Improvements start
    ...
    {
        CMarkingsUsed.Clear();
        MarkingData.Visible = false; //Wayfarer/Coyote
        CMarkingColors.Visible = false;
        _selectedMarking = null;

        SampleBox.Visible = false; //Wayfarer/Coyote
        SampleButton.Visible = false; //Wayfarer/Coyote
        SampleButton.Text = Loc.GetString("marking-show-sample-text"); //Wayfarer/Coyote
    ...
    private void ColorChanged(int colorIndex)
    {
        ...
        OnMarkingDataChanged?.Invoke(_currentMarkings); //Wayfarer/Coyote: OnMarkingColorChange? to OnMarkingDataChanged?
    }
    ...
    private void MarkingAdd()
    {
        ...
        OnUsedMarkingSelected(new ItemList.ItemListSelectedEventArgs(0, CMarkingsUsed)); //Wayfarer/Coyote: Select the newly added marking
